...
void PersonManager::seedDefaultData() {
    ...
    addPerson(new Student("Ahmad Habib", "11111-1111111-1", 19, "0300-0000000", "25-cs-042", 2, 3.4));
    addPerson(new GradStudent("Ali Hammad", "22222-2222222-2", 19, "0311-0000000", "---029", 2, 3.8, "Campus Management"));
    addPerson(new Student("Ahmad Habib", "55555-5555555-5", 19, "0344-0000000", "25-cs-042", 2, 3.2));
